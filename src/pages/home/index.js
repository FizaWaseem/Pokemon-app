...
import { Box, Flex, Grid, Stack, Text, Image } from "@chakra-ui/react";
    ...
    await SearchData(value)
      .then((res) => {
        if (res.status === 200) {
          ...
          setloader(false);
          alert(`${res} You Entered incorrect Data e.g pikachu`);
        }
      })
      .catch((error) => {
      ...
      {loader === true ? (
        ...
        <Grid templateColumns="repeat(1, 1fr)" gap={1} height="78vh">
          ...
          >
            ...
            <Box
              id="react-logo"
              w={{ base: 170, md: 380, lg: 370 }}
              h={{ base: 170, md: 380, lg: 370 }}
            />
            <Box
              id="pikachu"
              w={{ base: 170, md: 380, lg: 370 }}
